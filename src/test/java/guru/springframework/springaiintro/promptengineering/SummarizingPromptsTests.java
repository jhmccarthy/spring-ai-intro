...
class SummarizingPromptsTests extends BaseTest {
    ...
    private static final String REVIEW_2 = """
            ...
            """;
    private static final String REVIEW_3 = """
    ...
    private static final String REVIEW_PROMPT_3 = """
                ...
                Review 3: ```{review3}```
            """;
    private static final String REVIEW_PROMPT_4 = """
    ...
    @Test
    void createDescriptionFromReview() {
        var promptTemplate = new PromptTemplate(REVIEW_PROMPT);
    ...
    @Test
    void createDescriptionFrom3Reviews() {
        var promptTemplate = new PromptTemplate(REVIEW_PROMPT_3);
        var prompt = promptTemplate.create(
                Map.of(
                        "review", REVIEW_1,
                        "review2", REVIEW_2,
    ...
    @Test
    void createDescriptionFrom3ReviewsExtract() {
        var promptTemplate = new PromptTemplate(REVIEW_PROMPT_4);
        var prompt = promptTemplate.create(
                Map.of(
                        "review", REVIEW_1,
                        "review2", REVIEW_2,
