...
class InferenceTests extends BaseTest {
    ...
    private static final String REVIEW_4 = """
    ...
    private static final String REVIEW_5 = """
    ...
    private static final String REVIEW_6 = """
    ...
    private static final String EMOTION_PROMPT = """
            ...
            Review 6: ```{review6}```
            """;
    private static final String ANGER_TEST_PROMPT = """
    ...
    void testingSentiment() {
        var promptTemplate = new PromptTemplate(SENTIMENT_PROMPT);
    ...
    @Test
    void testingEmotion() {
        var promptTemplate = new PromptTemplate(EMOTION_PROMPT);
        var prompt = promptTemplate.create(
                Map.of("review1", REVIEW_1,
                        "review2", REVIEW_2,
                        "review3", REVIEW_3,
    ...
    void testingForAnger() {
        var promptTemplate = new PromptTemplate(ANGER_TEST_PROMPT);
        var prompt = promptTemplate.create(
                Map.of("review1", REVIEW_1,
                        "review2", REVIEW_2,
                        "review3", REVIEW_3,
